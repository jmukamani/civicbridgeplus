  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        />
        <DashboardCard 
          icon={<MessageSquare className="text-kenya-red" size={24} />}
          title={t('dashboard.unreadMessages')}
          value={unreadMessages}
          link="/citizen/messages"
        />
        <DashboardCard 
          icon={<User className="text-kenya-red" size={24} />}
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold">{t('dashboard.recentPolicies')}</h2>
          <Link 
            to="/citizen/policies" 
